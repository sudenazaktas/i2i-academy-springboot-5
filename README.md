...
## Endpoint
The application has one REST endpoint. Sending a GET request to /hello returns the message "Welcome to i2i Academy!".

## Cloud Deployment
After testing locally, the same application was deployed to a GCP Virtual Machine.
